...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Example Amber Hello web application."
  #
  #
  ...
  #
  # settings.secret_key_base= VqFLl8gpWSCZQkfzFEd4YDPjY7ssgFYytmna4bJPM_k
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("example_amber_hello.log", "w"))
  #
  #
end
